...
const EditPostPage = () => {
  ...
  useEffect(() => {
    if (blogData?.data) {
      ...
      reset({
        ...
        category: String(blog.category?.id || blog.categoryId || ""),
        tags: blog.tags || [],
  ...
  const updateBlogMutation = useMutation({
    mutationFn: ({ id: blogId, data }) => updateBlog(blogId, data),
    onSuccess: () => {
  ...
  const onSubmit = (data, status) => {
    ...
    updateBlogMutation.mutate({ id, data: blogPayload });
  };
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Perbarui konten artikel Anda</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {isSaving && pendingStatus === "PUBLISHED" ? (
                  <>
                    <Loader2 className="w-4 h-4 mr-1.5 animate-spin" />
                    Mempublikasi...
                  </>
